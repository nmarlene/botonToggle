...
function changePrice() {//
  ...
  if (priceMonthly.forEach(i => i.className.includes("inactive")) || bol.className.includes("check-bol")) {
  ...
  } else if (!priceMonthly.forEach(i => i.className.includes("inactive")) || !bol.className.includes("check-bol")) {
